...
const PICTO_VELO =
  'https://lxlvcwwvnujfbqgcfzze.supabase.co/storage/v1/object/public/HOME/emoji/picto-velo.png';
...
const ProgrammeAccordion: React.FC<{
  days: DestinationData['programmeDays'];
}> = ({ days }) => {
...
const FaqAccordion: React.FC<{ items: DestinationData['faq'] }> = ({ items }) => {
  const [openIndex, setOpenIndex] = useState<number | null>(null);
...
const LogementCarousel: React.FC<{
  images: DestinationData['logement']['images'];
}> = ({ images }) => {
    ...
    <div className="overflow-x-hidden bg-white font-sans" style={{ fontFamily: "'Poppins', sans-serif" }}>
            ...
            <div className="mx-auto grid max-w-6xl grid-cols-1 items-center gap-8 lg:grid-cols-[minmax(0,1fr)_minmax(0,1fr)] lg:gap-10">
              <ScrollAnimate className="flex flex-col justify-center lg:pr-4">
                <h2 className={sectionTitleOnOrangeClass}>
                  ...
                  pour votre <span className="font-bold">séminaire d&apos;entreprise&nbsp;?</span>
                </h2>
        ...
        <div className="mx-auto max-w-6xl px-5 sm:px-8">
          <div className="grid grid-cols-1 gap-10 lg:grid-cols-2 lg:gap-14 xl:gap-20">
            <ScrollAnimate>
              <h2 className={sectionTitleClass}>
                ...
                <span className="font-bold" style={{ color: HOME_COLORS.orange }}>
                  {destination.programmeAccent}
                </span>{' '}
                pour un événement d&apos;entreprise réussi {destination.prep} {destination.name}.
              </h2>
            ...
            <ScrollAnimate delay={80}>
              <ProgrammeAccordion days={destination.programmeDays} />
            </ScrollAnimate>
          </div>
        ...
        <div className="relative z-10 mx-auto max-w-6xl px-5 sm:px-8">
          <div className="grid grid-cols-1 items-center gap-8 lg:grid-cols-2 lg:gap-12">
            ...
            <ScrollAnimate delay={80} className="order-1 lg:order-2">
              <LogementCarousel images={destination.logement.images} />
            </ScrollAnimate>
          </div>
        </div>
      </section>
        ...
        <div className="relative z-10 mx-auto max-w-3xl px-5 sm:px-8">
          <ScrollAnimate>
            ...
            <p className={`mx-auto mt-3 max-w-lg text-center ${homeParagraphClass}`}>
              Une question sur un séminaire {destination.prep} {destination.name}&nbsp;? Parcourez la
              FAQ ou contactez-nous.
            </p>
          </ScrollAnimate>
      ...
      >
        <div className="mx-auto max-w-6xl px-5 sm:px-8">
          <ScrollAnimate>
            <h2 className={`text-center ${sectionTitleClass}`}>
              Explorez d&apos;autres <span className="font-bold">régions</span>.
            </h2>
            <p className={`mx-auto mt-3 max-w-lg text-center ${homeParagraphClass}`}>
              Découvrez d&apos;autres destinations TerraGo pour votre prochain séminaire d&apos;entreprise.
            </p>
          </ScrollAnimate>

          <div className="mt-8 grid grid-cols-1 gap-4 sm:mt-10 sm:grid-cols-2 sm:gap-5">
            {related.map((region, i) => (
              <ScrollAnimate key={region.slug} delay={i * 80}>
                <Link
