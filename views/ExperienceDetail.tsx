  ...
  if (!exp) {
    return (
      <div className="pt-32 pb-20 text-center">
        ...
        <Link href="/" className="text-orange font-bold uppercase tracking-widest text-xs">Retourner à l&apos;accueil</Link>
      </div>
    );
  }
                 ...
                 {otherExperiences.length > 0 && (
                   <div className="pt-6">
                      <div className="flex items-center justify-between mb-10">
                         ...
                         <Link href={`/producteur/${exp.host.id}`} className="text-[9px] font-bold uppercase tracking-widest text-orange border-b border-orange/20 pb-0.5 hover:border-orange transition-all">
                           Tout l'univers
                         </Link>
                      </div>
                 ...
                 <div className="space-y-8">
                    ...
                    <div className="pt-2">
                      <button 
                        ...
                        onClick={() => router.push(`/reservation?expId=${encodeURIComponent(id)}&date=${encodeURIComponent(selectedDate)}&time=${encodeURIComponent(selectedTime)}&guests=${guestCount}`)}
