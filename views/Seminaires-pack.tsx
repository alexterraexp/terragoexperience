  ...
  return (
    <div className="sem-img-wrap"
      ...
      <div key={photoKey} style={{ position: 'absolute', inset: 0, animation: `photoSlideIn${photoDir === 'right' ? 'Right' : 'Left'} 0.45s cubic-bezier(0.22,1,0.36,1) both` }}>
        <img src={currentImg} alt={`Séminaire ${titre} – ${region} – Terrago`} style={{ width: '100%', height: '100%', objectFit: 'cover', display: 'block', pointerEvents: 'none', userSelect: 'none' }} />
      </div>
...
export default function SeminairesPage() {
  ...
  <span className="font-sans font-bold text-3xl sm:text-4xl">Nos offres séminaires nature &amp; </span>
  <span className="font-display italic font-bold text-4xl sm:text-5xl">team building terroir.</span>
</h1>
          <p className="sr-only">
            Terrago propose des séminaires immersifs chez des producteurs du terroir français : vins, truffes, olives, cognac, piments et plus encore. Formats 1 journée, 2 jours ou sur mesure, de 6 à 150 participants. Team building nature, incentive terroir et séminaire engagé clé en main.
          </p>
          <p style={{ color: '#9a9080', fontSize: 13, maxWidth: 660, lineHeight: 1.75, margin: 0 }}>
            Séminaires au coeur des terroirs, 1 journée, 2 jours ou sur mesure — des team-buildings humains chez des producteurs français, authentiques et adaptés à vos équipes.
          </p>
        </div>
        ...
        <div style={{ marginTop: 96, paddingTop: 48, borderTop: '1px solid #e5e0d8' }}>
          <div className="sem-cta-band">
            <div>
              ...
              <p style={{ color: 'rgba(255,255,255,0.6)', fontSize: 13, margin: 0, lineHeight: 1.6 }}>Groupe de 5 à 100+ — on construit votre séminaire engagé sur mesure, chez un producteur choisi avec vous.</p>
            </div>
